...
let 哎呀呀这是我的ID啊 = ["6666"]; //这是你的ID，去除UUID规格限制，支持大小写字母和数字任意组合，安全性提高更不容易扫出，就是订阅链接的ID，[域名/ID]进入订阅页面
...
const 伪装网页 = 'https://cfip.nyc.mn/' //填入伪装网页，格式'www.youku.com'，如果不填，脚本本身有个内置的简单代理页面
