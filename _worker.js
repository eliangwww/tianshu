...
let 我的SOCKS5账号 = 'cmcc:cmcc@eliangwww.serv00.net:47663' //格式'账号:密码@地址:端口'

let 我的节点名字 = '🆓移动_请勿测速🚀' //自己的节点名字
let 我的节点名字2 = '🆓自适应_请勿测速🚀' //自己的节点名字



let 伪装网页 = 'www.cfip.nyc.mn' //填入伪装网页，格式'www.youku.com'，如果不填，脚本本身有个内置的简单代理页面，建议用小站伪装或者直接内置，比较靠谱
